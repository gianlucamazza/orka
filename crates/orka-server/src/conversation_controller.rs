...
impl From<orka_core::Error> for ControlError {
    fn from(e: orka_core::Error) -> Self {
        Self::Store(e)
    }
}
...
impl ConversationController {
    ...
    pub fn new_in_memory(cancel_tokens: SessionCancelTokens) -> Self {
        use orka_core::testing::{InMemoryBus, InMemoryConversationStore};
        Self::new(
